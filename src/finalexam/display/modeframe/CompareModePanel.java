...
import finalexam.display.modeframe.ModeInterface;
...
public class CompareModePanel extends JPanel implements ModeInterface {
    ...
    public CompareModePanel() {
        initComponents();
        this.array1 = SortingDisplay.generateRandomArray(200, 100);
        this.sorting1 = new BubbleSort(array1);
        comparePanel1.add(sorting1.getSortingDisplay());

        this.array2 = SortingDisplay.generateRandomArray(200, 100);
    ...
    private void compareComboBox1ActionPerformed(ActionEvent evt) {
        ...
        int[] x = SortingDisplay.generateRandomArray(200, 100);
        ...
        sorting1.sortingDisplay.setSize(799,170);
    ...
    private void compareComboBox2ActionPerformed(ActionEvent evt) {
        ...
        sorting2.sortingDisplay.setSize(799,170);
    ...
    public void resetArray() {
        int[] newValues = SortingDisplay.generateRandomArray(200, 100);
