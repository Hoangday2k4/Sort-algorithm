...
public class SingleModePanel extends JPanel implements ModeInterface {
    ...
    public SingleModePanel() {
        initComponents();
        this.array = SortingDisplay.generateRandomArray(200, 300);
    ...
    private void singleComboBoxActionPerformed(ActionEvent evt) {
        ...
        int[] x = SortingDisplay.generateRandomArray(200, 300);
    ...
    public void resetArray() {
        int[] newValues = SortingDisplay.generateRandomArray(200, 300);
